...
/**
 * Console command to decrypt all encrypted values in the database for entities with Encrypted properties.
 *
...
class DoctrineDecryptDatabaseCommand extends AbstractCommand
{
    ...
    /**
     * Decrypts encrypted values for the selected config(s), with optional progress bar and confirmation.
     *
